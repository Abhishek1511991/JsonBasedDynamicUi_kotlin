 ...
 */
class SignatureFactory : FormWidgetFactory {
    ...
    override fun getViewsFromJson(
        ...
        val linear_container = LayoutInflater.from(context)
            .inflate(R.layout.sign_layout_factory, null) as LinearLayout
        ...
        if (jsonObject?.has("editable") == true) {
            media_recyclerview_list.setTag(R.id.mEdit, jsonObject["editable"].toString())
        }
        media_recyclerview_list.setTag(R.id.alias, "")
